...
```{r ANOVA, message = FALSE, warning = FALSE, results="hide"}
#Anovas for Bean 
...
```{r Homosceraticity,message = FALSE, warning = FALSE, results="hide"}
#BEAN
bptest(anovabean3)
bptest(anovabean4)
bptest(anovabean5)
