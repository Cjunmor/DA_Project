...
In this project, we reanalyze and reformulate the results obtained by the authors using RStudio and  different packages that allow us to carry out any analysis and display the output in a more convenient way. 
...
3. Carry out a Principal Components Analisys (PCA) and a Linear Discriminant Analisys (LDA) in order to adress__________A Y U D A ____________
