...
Strains are not separated even a PCA for each crop is done. However, height and dry mass seem to be the parameters that separate the strains the most in all crops.
