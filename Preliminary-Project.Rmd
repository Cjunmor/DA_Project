...
3) The graphs that the authors chose in figure 6, are not random. They show what they consider it's more clear from each crop. This way, for example, in case of maize, it is quite clear that the different strains only have an effect in Plant Height, P Soil and N root. 
    Note one thing in the graphs of the article (fig. 6): graph H corresponds to *N soil (%)*,     and that does not correspond with any of the measurements of the green house experiments.     One may think that is due to a spelling error, but the results do not match any other         experiment.
4) The most efficient strains: This is done by hand, I've looking for some kind of package or command to select the data and create a table suitable for this, but I haven't find anything. I just created the table on Excel comparing the results in R, and the include the file in the Directory. Another way is to write the table (copy-pasting the data in this web: https://thisdavej.com/copy-table-in-excel-and-paste-as-a-markdown-table/ ), but there is no way to merge different rows, so it's not easy to understand. 

|                      | Bean           |            |                |               |                |         |         |        |         |        |
|----------------------|----------------|------------|----------------|---------------|----------------|---------|---------|--------|---------|--------|
|                      | Measurement    | Plant High | Shoot dry mass | Root dry mass | Total dry mass | P soil  | P shoot | P root | N shoot | N root |
| Most efficent strain | Kruskal-Wallis | -          | 183            | -             | -              | Control | -       | -      | -       | -      |
|                      |                |            | 24             |               |                |         |         |        |         |        |
|                      | Tukey          | Control    | -              | All           | All            | -       | 183     | All    | All     | All    |
|                      |                |            |                |               |                |         | 68      |        |         |        |
|                      |                |            |                |               |                |         | 179     |        |         |        |
|                      | Duncan         | Control    | -              | All           | 183            | -       | 183     | All    | 14      | All    |
|                      |                |            |                |               |                |         | 68      |        |         |        |
|                      |                |            |                |               |                |         | 179     |        |         |        |
...
|----------------------|----------------|------------|----------------|---------------|----------------|--------|---------|--------|---------|--------|
|                      | Measurement    | Plant High | Shoot dry mass | Root dry mass | Total dry mass | P soil | P shoot | P root | N shoot | N root |
| Most efficent strain | Kruskal-Wallis | -          | -              | -             | -              | All    | 14      | 183    | -       | -      |
|                      |                |            |                |               |                |        | 24      | 179    |         |        |
|                      |                |            |                |               |                |        | 62      |        |         |        |
|                      | Tukey          | 179        | All            | All           | All            | -      | -       | -      | All     | All    |
|                      | Duncan         | 179        | All            | 24            | 24             | -      | -       | -      | All     | All    |
...
|----------------------|----------------|------------|----------------|---------------|----------------|--------|---------|---------|---------|--------|
|                      | Measurement    | Plant High | Shoot dry mass | Root dry mass | Total dry mass | P soil | P shoot | P root  | N shoot | N root |
| Most efficent strain | Kruskal-Wallis | -          | -              | -             | -              | 24     | 24      | Control | -       | -      |
|                      |                |            |                |               |                |        |         | 65      |         |        |
|                      |                |            |                |               |                |        |         | 14      |         |        |
|                      |                |            |                |               |                |        |         | 24      |         |        |
|                      |                |            |                |               |                |        |         | 62      |         |        |
|                      | Tukey          | 65         | 65             | Control       | Control        | -      | -       | -       | All     | 65     |
|                      |                |            |                |               | 65             |        |         |         |         | 24     |
|                      | Duncan         | 65         | 65             | Control       | Control        | -      | -       | -       | All     | 65     |
|                      |                |            |                |               | 65             |        |         |         |         | 24     |

Note that, when the table says "All" means that all the strains are in the same group ("a"). We can assume that, even in those cases where ANOVA has confirmed that there are significant differences, these are not enough to identify different groups within the different strains. In those cases where the most effective strain is shown to be "Control" (no infection), we can assume that the strains do not have a positive effect in characteristic measured. The "-" indicates that that analysis has not been done in that situation. 
...
data.strains.beans <-  data.strains.beans %>% 
  rename("Crop" = bean.name,
         ...
         "Post-hoc analyses" = posthoc.bean,
